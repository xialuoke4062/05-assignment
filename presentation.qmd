...
![GDP per Capita](gdp_bar.png){fig:fig-bar width=60%}  
*Figure @fig:fig-bar from the report*

---

<!-- Scatter Plot Slide -->
# Scatter Plot: GDP Growth vs Life Expectancy  
![Growth vs Life](growth_vs_life.png){fig:fig-scatter width=60%}  
*Figure @fig:fig-scatter from the report*
...
*See Table @tbl:tbl-stats in the report.*
